...
@Mod(modid = FantasticAW.MODID, name = FantasticAW.NAME, version = FantasticAW.VERSION, dependencies = "required-after:fantasticlib@[1.12.2.044zzzz,);required-after:armourers_workshop@[1.12.2-0.51.0.659,)")
